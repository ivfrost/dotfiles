...
class RecorderIcon {
    constructor(applet) {
        ...
        this.icon_holder.set_clip_to_allocation(true);
...
class XAppStatusIcon {
    constructor(applet, proxy) {
      ...
      this.icon_holder.set_size(this.iconSize, this.iconSize);
this.icon_holder.set_x_expand(false);
this.icon_holder.set_y_expand(false);
  ...
  setIconName(iconName) {
    ...
    if (iconName.includes("/") && type !== St.IconType.SYMBOLIC) {
        this.icon_loader_handle = St.TextureCache.get_default().load_image_from_file_async(
            ...
            (cache, handle, actor) => {
                ...
                actor.set_size(this.iconSize, this.iconSize);
    ...
    // Constrain holder
    this.icon_holder.set_size(this.iconSize, this.iconSize);
    this.icon_holder.set_x_align(Clutter.ActorAlign.CENTER);
    this.icon_holder.set_y_align(Clutter.ActorAlign.CENTER);
    this.icon_holder.set_x_expand(false);
    this.icon_holder.set_y_expand(false);
}
  ...
  _onImageLoaded(cache, handle, actor, data=null) {
    ...
    actor.set_content_scaling_filters(Clutter.ScalingFilter.TRILINEAR, Clutter.ScalingFilter.TRILINEAR);
    actor.set_size(this.iconSize, this.iconSize);
    actor.set_width(this.iconSize);
    actor.set_height(this.iconSize);
    
    actor.set_keep_aspect_ratio(true);
    actor.set_natural_width(this.iconSize);
    actor.set_natural_height(this.iconSize);
