...
const S_ICON_OFF = "night-light-disabled-symbolic";
const S_ICON_ON = "night-light-symbolic";
...
class QRedshift extends Applet.TextIconApplet {
    ...
    doUpdate() {
      let period = this.check_period();
      let isNight = period.is_night;
      
      let shouldShow =
          this.opt.enabled &&
          this.opt.enabledNight && 
          isNight
